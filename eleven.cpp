...
int main() {
  ...
  long long maxProd = numeric_limits<long long>::lowest();

  for (int r = 0; r < rows; r++) {
    for (int c = 0; c < cols; c++) {
      // Rows:
      if (c + 3 < cols) {
        long long prod = 1LL * matrix[r][c] * matrix[r][c + 1] *
      ...
      // Cols:
      if (r + 3 < rows) {
        long long prod = 1LL * matrix[r][c] * matrix[r + 1][c] *
      ...
      if (((r + 3) < rows) && ((c + 3) < cols)) {
        long long prod = 1LL * matrix[r][c] * matrix[r + 1][c + 1] *
